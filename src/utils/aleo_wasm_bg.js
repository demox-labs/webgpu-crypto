...
function __wbg_adapter_26(arg0, arg1, arg2) {
    wasm._dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h1f7591f361f79faf(arg0, arg1, addHeapObject(arg2));
}
...
export class Program {
    ...
    */
    id() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.program_id(retptr, this.ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            return getStringFromWasm0(r0, r1);
        } finally {
    ...
    * @returns {Program}
    */
    static from_string(program) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passStringToWasm0(program, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            wasm.program_from_string(retptr, ptr0, len0);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            if (r2) {
    ...
    */
    to_string() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.program_to_string(retptr, this.ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            return getStringFromWasm0(r0, r1);
        } finally {
...
export class ProvingKey {
    ...
    */
    static from_bytes(bytes) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.provingkey_from_bytes(ptr0, len0);
    ...
    */
    to_bytes() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.provingkey_to_bytes(retptr, this.ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
...
export class TransactionBuilder {
    ...
    * @returns {string}
    */
    static build_transition(program, function_name, inputs, private_key, proving_key) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            ...
            const len1 = WASM_VECTOR_LEN;
            const ptr2 = passStringToWasm0(inputs, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len2 = WASM_VECTOR_LEN;
            _assertClass(private_key, PrivateKey);
            var ptr3 = private_key.__destroy_into_raw();
            _assertClass(proving_key, ProvingKey);
            var ptr4 = proving_key.__destroy_into_raw();
            wasm.transactionbuilder_build_transition(retptr, ptr0, ptr1, len1, ptr2, len2, ptr3, ptr4);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            var r3 = getInt32Memory0()[retptr / 4 + 3];
    ...
    * @returns {string}
    */
    static build_transaction(inclusion_key, intermediate_transactions, state_root, commitment_map) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            _assertClass(inclusion_key, ProvingKey);
            var ptr0 = inclusion_key.__destroy_into_raw();
            const ptr1 = passStringToWasm0(intermediate_transactions, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len1 = WASM_VECTOR_LEN;
            const ptr2 = passStringToWasm0(state_root, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len2 = WASM_VECTOR_LEN;
            const ptr3 = passStringToWasm0(commitment_map, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len3 = WASM_VECTOR_LEN;
            wasm.transactionbuilder_build_transaction(retptr, ptr0, ptr1, len1, ptr2, len2, ptr3, len3);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            var r3 = getInt32Memory0()[retptr / 4 + 3];
    ...
    * @returns {string}
    */
    static verify_transaction(transaction_string, program, function_name, function_verifying_key, inclusion_key, verify_inclusion, verify_execution) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passStringToWasm0(transaction_string, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            _assertClass(program, Program);
            ...
            const len2 = WASM_VECTOR_LEN;
            _assertClass(function_verifying_key, VerifyingKey);
            var ptr3 = function_verifying_key.__destroy_into_raw();
            _assertClass(inclusion_key, VerifyingKey);
            var ptr4 = inclusion_key.__destroy_into_raw();
            wasm.transactionbuilder_verify_transaction(retptr, ptr0, len0, ptr1, ptr2, len2, ptr3, ptr4, verify_inclusion, verify_execution);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            var r3 = getInt32Memory0()[retptr / 4 + 3];
...
export class VerifyingKey {
    ...
    */
    static from_bytes(bytes) {
        const ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.verifyingkey_from_bytes(ptr0, len0);
    ...
    */
    to_bytes() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.verifyingkey_to_bytes(retptr, this.ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            var r3 = getInt32Memory0()[retptr / 4 + 3];
...
export function __wbindgen_closure_wrapper5412(arg0, arg1, arg2) {
    const ret = makeMutClosure(arg0, arg1, 981, __wbg_adapter_26);
    return addHeapObject(ret);
};
