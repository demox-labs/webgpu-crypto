...
export const field_multiply = async (input1: Array<number>, input2: Array<number>) => {
  const shaderEntry = `
    @group(0) @binding(0)
    ...
    fn main(
      ...
      var result = field_multiply(input1.u256s[global_id.x], input2.u256s[global_id.x]);
...
(window as any).field_multiply = field_multiply;