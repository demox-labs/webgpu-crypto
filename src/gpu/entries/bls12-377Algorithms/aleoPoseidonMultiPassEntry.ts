...
export const aleo_poseidon_multi = async (input1: Array<number>, input2: Array<number>, input3: Array<number>) => {
  ...
  const nonArryBufferSize = Uint32Array.BYTES_PER_ELEMENT * numInputs * FIELD_SIZE;
  const arrayBufferSize = Uint32Array.BYTES_PER_ELEMENT * numInputs * FIELD_SIZE * 9; // Because 9 fields per array
  ...
  const finalShaderCode = [U256WGSL, BLS12_377ParamsWGSL, FieldModulusWGSL, finalEntry];
