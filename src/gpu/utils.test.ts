...
const testData: [bigint, Uint32Array][] = [
  ...
  [FIELD_MODULUS, new Uint32Array([313222494, 2586617174, 1622428958, 1547153409, 1504343806, 3489660929, 168919040, 1])],
  ...
  [BigInt('40770029410420498293352137776570907027550720424234931066070132305056'), new Uint32Array([0, 0, 0, 0, 0, 0, 0, 0])]
];
