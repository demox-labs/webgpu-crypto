...
const testData: [bigint, Uint32Array][] = [
  ...
  [BLS12_377_MODULUS, new Uint32Array([313222494, 2586617174, 1622428958, 1547153409, 1504343806, 3489660929, 168919040, 1])],
  ...
  [BigInt('5472060717959818805561601436314318772174077789324455915672259473661306552146'), new Uint32Array([0,0,0,0,0,0,0,0])],
  [BN254_MODULUS, new Uint32Array([811880050, 3778125865, 3092268470, 2172737629, 2541841041, 1752287885, 1008765974, 3632069959])]
];
