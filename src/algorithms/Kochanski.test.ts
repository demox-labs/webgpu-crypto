...
describe('Kochanski', () => {
    it.each([
        ...
        [ALEO_FIELD_MODULUS, BigInt(0), ALEO_FIELD_MODULUS, BigInt(0)],
        [ALEO_FIELD_MODULUS, BigInt(2), ALEO_FIELD_MODULUS, BigInt(0)],
        [ALEO_FIELD_MODULUS, ALEO_FIELD_MODULUS, ALEO_FIELD_MODULUS, BigInt(0)],
        [ALEO_FIELD_MODULUS + BigInt(2), BigInt(2), ALEO_FIELD_MODULUS, BigInt(4)],
